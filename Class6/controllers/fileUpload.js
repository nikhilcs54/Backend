...
exports.imageUpload = async (req, res) => {
    try{
        ...
        console.log("Uploading to NikhilCloudDB");
        const response = await uploadFileToCloudinary(file, "NikhilCloudDB");
...
exports.imageSizeReducer = async (req,res) => {
    try{
        ...
        const response = await uploadFileToCloudinary(file, "NikhilCloudDB", 90);
        console.log(response);
